...
namespace Recyclerview
{
    ...
    public class MainActivity : Activity
    {
        ...
        public class RecyclerAdapter : RecyclerView.Adapter
        {
            ...
            public RecyclerAdapter(ContactListAdapter<ContactList> Mitems, RecyclerView recycler)
            {
                this.Mitems = Mitems;
            ...
            public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
            {
                ...
                CheckedTextView check = LayoutInflater.From(parent.Context).Inflate(global::Android.Resource.Layout.SimpleListItemChecked, parent, false) as CheckedTextView;
                return view;
            }
